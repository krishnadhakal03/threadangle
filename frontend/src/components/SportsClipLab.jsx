...
const EXAMPLES = {
  ...
  arsenal: {
    label: 'Arsenal title chase',
    eventTopic: 'Arsenal historic title chase',
    sport: 'EPL',
    teamsPlayers: 'Arsenal, title race, Premier League, Champions League',
    targetPlatform: 'All',
    duration: '20s',
    pacingMode: 'balanced',
    tone: 'hype',
    hook: '22 YEARS. 2 GAMES LEFT.',
    body: 'Arsenal can turn a generation of waiting into history, but every rival result makes the pressure louder.',
    cta: 'PL, UCL, both, or heartbreak?',
    template: 'historic-title-chase',
    worldCupMode: false,
    titleRaceTeam: 'Arsenal',
    yearsWaiting: '22',
    gamesLeft: '2',
  ...
  goat: {
    label: 'Messi vs Ronaldo GOAT debate',
    eventTopic: 'Messi vs Ronaldo GOAT debate',
    sport: 'Football',
    teamsPlayers: 'Lionel Messi, Cristiano Ronaldo, legacy debate',
    targetPlatform: 'All',
    duration: '20s',
    pacingMode: 'hyper',
    tone: 'rivalry',
    hook: 'The GOAT debate still splits every football room.',
    body: 'Magic, power, trophies, records, clutch nights, and the moments people never stop arguing about.',
    cta: 'Pick one side and give your reason.',
    template: 'messi-ronaldo-rivalry',
    worldCupMode: false,
  },
  knockout: {
