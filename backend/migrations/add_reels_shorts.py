"""
Migration: add_reels_shorts
Adds Instagram Reels and YouTube Shorts metadata columns to the generations table.

Usage:
    cd backend
    python migrations/add_reels_shorts.py
"""
import os
import sys
import sqlite3
...
def upgrade():
    ...
    columns_to_add = [
        ("reels_title", "TEXT"),
        ("reels_description", "TEXT"),
        ("reels_hashtags", "TEXT"),
        ("reels_title_edited", "TEXT"),
        ("reels_description_edited", "TEXT"),
        ("reels_hashtags_edited", "TEXT"),
        ("shorts_title", "TEXT"),
        ("shorts_description", "TEXT"),
        ("shorts_tags", "TEXT"),
        ("shorts_title_edited", "TEXT"),
        ("shorts_description_edited", "TEXT"),
        ("shorts_tags_edited", "TEXT"),
    ]
