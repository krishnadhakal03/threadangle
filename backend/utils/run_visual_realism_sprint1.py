...
def build_grocery_scenes() -> list[dict[str, Any]]:
    return [
        _scene(
            ...
            1.45,
            "I found a $40/week leak in my grocery receipt.",
            "I found a $40/week leak.",
        ...
        _scene(
            ...
            2.9,
            "That is about $2,080/year back from one boring receipt audit.",
            "About $2,080/year.",
            number="$2,080",
