...
RUN_ID = "phase3b_widescreen_real_coding_poc_v1"
WIDTH = 1920
HEIGHT = 1080
FPS = 30
WORK_DIR = TEMP_DIR / RUN_ID
REVIEW_DIR = ASSETS_DIR / "review" / RUN_ID
CAPTURE_DIR = TEMP_DIR / RUN_ID
...
SEGMENTS = [
    {
        "name": "final_extension_demo_open",
        "source": BROWSER_CAPTURE,
        "start": 22.0,
        "duration": 9.0,
        "caption": "This is the extension working first.",
    ...
    },
    {
        ...
        "start": 3.0,
        "duration": 10.0,
        "caption": "Codex generated the extension files.",
        "requirement": "code generation",
    },
    {
        "name": "bug_fix_terminal",
        "source": VSCODE_CAPTURE,
        "start": 22.0,
        "duration": 12.0,
        "caption": "The first run exposed a popup issue.",
    ...
    },
    {
        ...
        "start": 13.0,
        "duration": 16.0,
        "caption": "It summarized a real demo webpage.",
        "requirement": "extension working on webpage",
    },
]
...
def make_cta_clip() -> Path:
    ...
    center_text(draw, (300, 290, 1620, 430), "COMMENT EXTENSION", font(92, True), (255, 255, 255))
    center_text(draw, (300, 500, 1620, 640), "FOR FULL BUILD", font(82, True), (82, 196, 255))
    center_text(draw, (300, 730, 1620, 805), "60-second real-coding proof", font(42, True), (255, 255, 255))
...
def make_audio() -> tuple[str, list[dict]]:
    texts = [segment["caption"] for segment in SEGMENTS] + ["Comment EXTENSION for the full tutorial."]
...
def make_review_artifacts() -> tuple[Path, list[Path]]:
    ...
    for idx, t in enumerate([4, 12, 22, 35, 49, 62, total - 2], start=1):
